...
data_1001 <- subset(data_s, Peak >= 975 & Peak <= 977)
data_1510 <- subset(data_s, Peak >= 1480 & Peak <= 1482)
data_1458 <- subset(data_s, Peak >= 1140 & Peak <= 1141)
data_1285 <- subset(data_s, Peak >= 1160 & Peak <= 1162)


#datos de superficie
data_final <- list(data_1510,data_1458,data_1285, data_1001)
...
g + scale_y_continuous(trans='log10', limits = c(10,2000)) + 
  labs(title = "Band intensity differences between regolith simulants - Histidine"
