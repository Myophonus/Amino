...
data_1510 <- subset(data_s, Peak >= 1300 & Peak <= 1302)
data_1458 <- subset(data_s, Peak >= 1020 & Peak <= 1021)
data_1285 <- subset(data_s, Peak >= 1210 & Peak <= 1211)
data_1198 <- subset(data_s, Peak >= 643 & Peak <= 644)
data_1154 <- subset(data_s, Peak >= 830 & Peak <= 832)
data_1000 <- subset(data_s, Peak >= 850 & Peak <= 852)
data_1001 <- subset(data_s, Peak >= 1178 & Peak <= 1180)
data_1002 <- subset(data_s, Peak >= 1606 & Peak <= 1607)
data_1003 <- subset(data_s, Peak >= 1250 & Peak <= 1251)





data_1510 <- subset(data_s, Peak >= 828 & Peak <= 830)
...
g + scale_y_continuous(trans='log10', limits = c(10,1000)) + 
  labs(title = "Band intensity differences between regolith simulants - Tyrosine"
